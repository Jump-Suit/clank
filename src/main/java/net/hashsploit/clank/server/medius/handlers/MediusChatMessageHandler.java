...
public class MediusChatMessageHandler extends MediusPacketHandler {
	...
	public List<MediusMessage> write(MediusClient client) {
		...
		ChatFwdMessageResponse responsePacket = new ChatFwdMessageResponse(requestPacket.getMessageId(), Utils.buildByteArrayFromString(username, MediusConstants.USERNAME_MAXLEN.value), byteMsg, requestPacket.getMessageType());
